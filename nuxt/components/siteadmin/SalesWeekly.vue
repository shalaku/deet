...
const handleSubmit = () => {
  const paramsOrderHistory = {
    ...
    min_week: start_week.value,
    max_week: end_week.value,
...
onMounted(() => {
  ...
  start_week.value = currentWeek;
  end_week.value = currentWeek;
  handleSubmit();   
});
              ...
              <form @submit.prevent="handleSubmit">
                <div class="row">
                  <div class="mb-3 col-3">
                    <label for="startWeek" class="form-label">開始月</label>
                    <input v-model="start_week" type="week" id="startWeek" class="form-control">
                  </div>
                  <div class="mb-3 col-3">
                    <label for="endWeek" class="form-label">終了月</label>
                    <input v-model="end_week" type="week" id="endWeek" class="form-control">
                  </div>
