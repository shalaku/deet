	...
	<div class="page-user min-vh-100 d-flex justify-content-center align-items-center">
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="tab-container-wrapper mb-5">
					<div class="tab-container login-title text-center">
						<button class="active">ログイン</button>
						<!-- <button class="" @click="goToRegister">新規登録</button> -->
					</div>
				</div>


				<NuxtLink to="/user/login" class="btn submit-btn fw-bold" type="submit">ユーザー</NuxtLink>
				<NuxtLink to="/cast/login" class="btn submit-btn fw-bold" type="submit">女性会員</NuxtLink>
				...
				<footer class="footer">
					...
					<div class="d-flex justify-content-evenly text-center">
						...
						<div><a href="" class="text-12px">特定商法に基づく表示</a></div>
					</div>
					<hr />
